...
These fields should be populated by the prospect-researcher or carrier-appetite agent before Gretchen or Lamar touches the file.
...
These fields are not intake data — they are signals that Claude agents should flag to `#lamar-alerts` when identified.
...
All fields marked `[R]` in sections 1–7 must be confirmed before submission. Claude agents must enforce this gate.
...
- Zoho CRM field names and enums (CRM of record)
- [[Opportunity Entity — Complete Field Reference]] — Pipeline stage and LOB fields

---
*Generated by Claude — update this file whenever the intake template changes. Commit to GitHub after every edit.*
