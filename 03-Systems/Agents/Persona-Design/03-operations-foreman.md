...
RSG runs on: NowCerts (AMS / system of record), Zoho CRM (pipeline + tasks), Claude agents (automation), Slack (comms).
...
- Format it as a Slack message or Zoho CRM task Lamar can send directly
...
- Follow-up tasks assigned to her in Zoho CRM
...
- The SOP exists but isn't in Gretchen's reach (buried in Zoho CRM)
...
- Follow-up tasks assigned via Zoho CRM/Slack
...
> 4. Log results in the Johnson Zoho CRM renewal record under "Market Check Results"
