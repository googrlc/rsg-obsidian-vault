    ...
    steps:
      ...
      - name: Deploy migrations
        ...
        env:
          ...
          SUPABASE_PROJECT_ID: wibscqhkvpijzqbhjphg
```
...
```toml
project_id = "wibscqhkvpijzqbhjphg"
```
...
4. Push triggers GitHub Actions → migrations deploy automatically to Supabase project `wibscqhkvpijzqbhjphg`
